...
archivos = ["a_example.txt", "b_lovely_landscapes.txt", "c_memorable_moments.txt", "d_pet_pictures.txt",
            "e_shiny_selfies.txt"]
for archivo in archivos:
    ...
    print("Fotos totales %s,verticales %s, horizonateles %s, tags totales %s" % (
        numFotos, numFotosVerticales, numFotosHorizonales, numTags))
...
solucion = algoritmo.algoritmo2(infogeneral, diccionarioFotos, diccionarioTags, 1, paramMinimoH=4, paramMaximoH=7,
                                paramMinimoV=3, paramMaximoV=6, paramParada=0.05)
...
cProfile.run(
    "algoritmo.algoritmo2(infogeneral,diccionarioFotos,diccionarioTags,1,paramMinimoH=2,paramMaximoH=8,paramMinimoV=2,paramMaximoV=6,paramParada=0.2)")
...
def ejecutar(i, archivo, shared_list):
    ...
    infogeneral, diccionarioFotos, diccionarioTags = leerArchivo.leerArchivo("entrada/" + archivo)
    solucion = algoritmo.algoritmo2(infogeneral, diccionarioFotos, diccionarioTags, 1, paramMinimoH=2, paramMaximoH=8,
                                    paramMinimoV=1, paramMaximoV=7, paramParada=0.01)
