...
archivo = archivos[4]
infogeneral, diccionario1, ingredientes = leerArchivo.leerArchivo("entrada/" + archivo)
solucion = algoritmo.algoritmo2(diccionario1, ingredientes, infogeneral[0], operator.ge, numeroInicios=30,
                                aleatorizacionIngredientes=10)
...
for archivo in archivos:
    infogeneral, diccionario1, ingredientes = leerArchivo.leerArchivo("entrada/" + archivo)
    solucion, c = algoritmo.algoritmo5(diccionario1, ingredientes, infogeneral[0], operator.ge, numeroAgrupacion=20,
                                       iteraciones=100, param1=1, param2=1, salto=50, inicios=5, aleatoriedad=100)
    print(c)
    archivoSolucion = "salida/solucion_" + archivo[0]
    escribirArchivo.escribirSolucion(solucion, archivoSolucion)
tiempo2 = time.time()
...
while (c < 2000):
    ...
    solucion, c = algoritmo.algoritmo2(diccionario1, ingredientes, infogeneral[0], operator.ge, numeroAgrupacion=20,
                                       iteraciones=100)
    print(c)
    archivoSolucion = "salida/solucion_" + archivo[0]
    escribirArchivo.escribirSolucion(solucion, archivoSolucion)
