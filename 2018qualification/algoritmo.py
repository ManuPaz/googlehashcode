...
def algoritmo1(numRows, numColumns, numVehicles, numRides, bonus, steps, rides, paramBusqueda=100, paramParada=100000, momento="start"):
...
def algoritmo2(numRows, numColumns, numVehicles, numRides, bonus, steps, rides, paramBusqueda=100, paramParada=100000, momento="start",parametroDeEspera=None):
    print("R %s, C %s, V %s, Rides %s, Bonus %s, time %s" %
          (numRows, numColumns, numVehicles, numRides, bonus, steps))
    solucion = []
    ridesList = [ride for ride in rides.keys()]
...
def algoritmo3(numRows, numColumns, numVehicles, numRides, bonus, steps, rides, paramBusqueda=100, paramParada=100000, momento="start",parametroDeEspera=None):
    print("R %s, C %s, V %s, Rides %s, Bonus %s, time %s" %
          (numRows, numColumns, numVehicles, numRides, bonus, steps))
    solucion = []
    ridesList = [ride for ride in rides.keys()]
