...
solucion = algoritmo.algoritmo2(numRows, numColumns, numVehicles, numRides, bonus, steps, rides, paramBusqueda=100,
                                momento="end", parametroDeEspera=parametroDeEspera)
...
import cProfile
cProfile.run(
    "algoritmo.algoritmo2(numRows,numColumns,numVehicles,numRides,bonus,steps,rides,paramBusqueda=100,momento='end',parametroDeEspera=parametroDeEspera)")
